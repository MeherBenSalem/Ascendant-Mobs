		...
		if (entity.getPersistentData().getBoolean("am_boss")) {
			...
			if (!world.isClientSide() && world.getServer() != null) {
				for (ItemStack itemstackiterator : world.getServer().getLootData()
						.getLootTable(new ResourceLocation((JaumlConfigLib.getStringValue("RpgMobLevelingSystem", "global_settings", "ascendant_loot_table")).toLowerCase(java.util.Locale.ENGLISH)))
