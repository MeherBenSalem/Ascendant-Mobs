	...
	public static void execute(LevelAccessor world, CommandContext<CommandSourceStack> arguments, Entity entity) {
		...
		if (entity instanceof Player _player && !_player.level().isClientSide())
			_player.displayClientMessage(Component.literal(("\u00A74[Debug] \u00A7fRecommended distance to get this level at this distance is \u00A76"
					+ Math.round((spawnlocation * JaumlConfigLib.getNumberValue("RpgMobLevelingSystem", "scale_settings", "scale_factor")) / DoubleArgumentType.getDouble(arguments, "level")))), false);
	}
}