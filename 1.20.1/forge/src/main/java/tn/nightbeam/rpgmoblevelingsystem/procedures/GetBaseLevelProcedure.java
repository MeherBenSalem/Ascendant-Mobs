...
public class GetBaseLevelProcedure {
	public static double execute(LevelAccessor world) {
		...
		toReturn = JaumlConfigLib.getNumberValue("RpgMobLevelingSystem", "scale_settings", "base_level");
		count = 0;
		for (int index0 = 0; index0 < (int) JaumlConfigLib.getArrayLength("RpgMobLevelingSystem", "dimensions_settings", "dimensions"); index0++) {
			stringToCheck = JaumlConfigLib.getArrayElement("RpgMobLevelingSystem", "dimensions_settings", "dimensions", ((int) count));
